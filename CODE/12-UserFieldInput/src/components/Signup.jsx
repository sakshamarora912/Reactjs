...
export default function Signup() {
  ...
  function handleSubmit(event) {
    ...
    const checkboxData=formData.getAll('acquisition');
    const data=Object.fromEntries(formData.entries());
    data.aquisition=checkboxData;
    setEmail(data.email)
    
 console.log(password,data['conform-password']);
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="control-row">
        ...
        <div className="control">
          ...
          <div className="control-error">{!passwordsMatch && <p>Password Not Match</p>}</div>
        </div>
      </div>
      <hr />
