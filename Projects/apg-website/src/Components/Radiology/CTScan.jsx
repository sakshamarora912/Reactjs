...
const CTScan = () => {
  return (
    <section className="p-6 bg-white max-w-4xl mx-auto">
      <h1 className="text-3xl sm:text-4xl md:text-5xl font-semibold mb-4">MRI Scan Cost</h1>
      ...
      <div className="text-center mb-6">
        <a
          href="https://apg.com/book-now"
          className="px-6 py-3 bg-[#5183a2] text-white rounded-md hover:bg-blue-700"
        >
          Book Now
        </a>
      </div>
      ...
      <h2 className="text-2xl sm:text-3xl md:text-4xl font-semibold mb-4">What is an MRI Scan?</h2>
      <p className="text-lg sm:text-xl md:text-2xl mb-6">
      ...
      <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4">Types of MRI Scans</h3>
      <p className="text-lg sm:text-xl md:text-2xl mb-6">
      ...
      <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4">Benefits of an MRI Scan</h3>
      <p className="text-lg sm:text-xl md:text-2xl mb-6">
      ...
      <h3 className="text-xl sm:text-2xl md:text-3xl font-semibold mb-4">Where can you get an MRI Scan?</h3>
      <p className="text-lg sm:text-xl md:text-2xl mb-6">
