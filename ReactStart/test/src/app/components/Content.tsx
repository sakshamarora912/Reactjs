...
import { headingStyle, headingFont, descriptionStyle,descriptionFont} from './Style'
import {
  Form,
  FormControl,
  FormField,
...
export function Content({ formData, updateFormData }: ContentProps) {
  ...
  const headingStle:CSS.Properties={
    fontSize:headingFont, fontStyle:headingStyle,
  }
  const descriptionStle:CSS.Properties={
    fontSize:descriptionFont, fontStyle:descriptionStyle,
  }
      ...
      >
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormLabel style={headingStle}>Heading</FormLabel>
              <FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <div className="space-y-0.5"></div>
              <FormLabel style={descriptionStyle}>Description</FormLabel>
              <FormControl>
                {/*      
               <Tiptap onChange={field.onChange} value={field.value}  /> */}
                <Input
